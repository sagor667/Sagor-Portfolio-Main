...
const content = {
  en: {
    ...
    subtitle: 'I craft high-performance full-stack web applications and custom WordPress websites that convert visitors into clients.',
    hire: 'Hire Me',
  ...
  bn: {
    ...
    subtitle: 'আপনার ব্যবসার ডিজিটাল রূপান্তরে আমি দিচ্ছি আধুনিক ফুলস্ট্যাক ডেভেলপমেন্ট এবং কাস্টম ওয়ার্ডপ্রেস সলিউশন—যা কেবল সুন্দরই নয়, বরং আপনার ব্যবসার সেলস বাড়াতেও সাহায্য করবে।',
    hire: 'চলুন যোগাযোগ করি',
    projects: 'আমার কাজগুলো দেখুন',
    stats: [
      { value: '3+', label: 'বছরের অভিজ্ঞতা' },
      { value: '100+', label: 'সফল প্রজেক্ট' },
      { value: '80+', label: 'সন্তুষ্ট ক্লায়েন্ট' },
    ],
          ...
          <div className="hero-avatar-wrapper">
            <div className="hero-avatar-ring animate-float">
              <div className="hero-avatar-inner">
                <Image src="/images/profile.png" alt={t.name} fill style={{ objectFit: 'cover', objectPosition: 'center' }} priority />
              </div>
            </div>
